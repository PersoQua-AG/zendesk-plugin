Paste everything below this line as the first message of a fresh Claude Code session in this repo (`/Users/pfist/Developer/Otterstedt/persoqua/Claude Plugins/Zendesk Plugin`).
